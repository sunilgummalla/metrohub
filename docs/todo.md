...
- [ ] Render categorized clickable app tiles in the shell with sticky header and footer.
- [ ] Choose the Git pipeline provider and CI/CD conventions.
- [ ] Add build, test, and deployment jobs for API, experience, shell, and micro-app packages once projects exist.
